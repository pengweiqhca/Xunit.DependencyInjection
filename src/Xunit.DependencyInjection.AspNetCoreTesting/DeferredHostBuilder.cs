...
internal sealed class DeferredHostBuilder : IHostBuilder, IDisposable
{
    ...
    private sealed class DeferredHost : IHost, IAsyncDisposable
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken = default)
        {
            ...
            await using var reg = cancellationToken.UnsafeRegister(_ => _hostStartedTcs.TrySetCanceled(), null)
            ...
            await using var reg2 = _host.Services.GetRequiredService<IHostApplicationLifetime>().ApplicationStarted.UnsafeRegister(_ => _hostStartedTcs.TrySetResult(), null)
                .ConfigureAwait(false);
    ...
    public void Dispose() => _hostConfiguration.Dispose();
}
